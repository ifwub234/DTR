...
class LanguageBindVideoProcessor(ProcessorMixin):
    ...
    def __call__(self, images=None, text=None, context_length=77, return_tensors=None, **kwargs):
        ...
        if images is not None:
            ...
            image_features = [self.image_processor(image, self.transform,
                                                   ...
                                                   num_frames=kwargs.get('num_frames', self.config.vision_config.num_frames)) for image in images]
    ...
    def preprocess(self, images, return_tensors, **kwargs):
        return self.__call__(images=images, return_tensors=return_tensors, **kwargs)
